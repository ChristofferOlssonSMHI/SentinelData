...
def request_url():
    ...
    end_date = '2024-07-27T00:00:00.000Z'
    ...
    # url = (
    #     "https://catalogue.dataspace.copernicus.eu/odata/v1/Products?$filter=Name eq "
    #     "'S2A_MSIL1C_20240726T100601_N0511_R022_T34VDH_20240726T153045.SAFE'"
    # )
...
# Uncomment this when you just want to search for products without downloading
id_list(request_url())

# Uncomment this when you want to download the products
